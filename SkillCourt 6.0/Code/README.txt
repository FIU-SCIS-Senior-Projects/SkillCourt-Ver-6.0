...
PLEASE USE FOLDER NAMED: "New 6.0 Version"
...
# Installation and maintenance is thuroughly explained in the following video:
...
- adapters:     This folder contains all the classes you will use to show lists or options. Right now only contains GamesPlayedRecyclerViewAdapter which you can find on the main dashboard screen.
...
You can create one using the following link : 
https://console.firebase.google.com/



Also if you would like to learn more and what else can you do with firebase: 
