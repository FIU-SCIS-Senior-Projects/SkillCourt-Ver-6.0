 ...
 */
public class Arduino2 implements SerialPortEventListener
{
        ...
        try
        {
            ...
            switch (oEvent.getEventType())//Change from switch to if/else?***
            {
                ...
                case SerialPortEvent.DATA_AVAILABLE:
                    ...
                    arduinoInterface.receivedData(fromPad);
//                    if(fromPad == 0)
//                    {
...
//                    }
    ...
    public Arduino2(ArduinoInterface arduinoInterface)//What is this for?
    {
